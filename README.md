...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/idds-workflow-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13447&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/idds-workflow-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `idds-workflow` can be installed with:

```
conda install idds-workflow
```

It is possible to list all of the versions of `idds-workflow` available on your platform with:
